...
void StartProcWSF() {
	...
	aProcs.StartAsCScriptFiles(strLocalPathWSF, iTimeOut00);
}
...
void StartProcBAT() {
	...
	aProcs.StartAsCmdFile(strLocalPathCmd, iTimeOut00);
}
...
void StartProcPS1() {
	...
	aProcs.StartAsPoshFile(strLocalPathPS1, iTimeOut00);
}
...
void StartProcNotepad() {
	...
	aProcs.StartAsNotepad(strLocalPath, iTimeOut00);
}
...
void StartProcFile() {
	...
	aProcs.StartFile(strLocalPath, iTimeOut00);
}
